        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            <div class="mb-4">
                <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                    <p class="text-base font-semibold uppercase tracking-wide text-gray-600">
                        Contact
                    </p>
                    <h2
                    ...
                    <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600">Akid ltd ©
                    </p>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-3">
                    ...
                    <div class="h-full pr-6">
                        <p class="mt-3 mb-12 text-lg text-gray-600">
                            You can reach out to us from the following info:
                        </p>
                        <ul class="mb-6 md:mb-0">
                            <li class="flex">
                                ...
                                <div class="ml-4 mb-4">
                                    ...
                                    <p class="text-gray-600 dark:text-slate-400">1/4 8G Jalan, Sentul,</p>
                                    <p class="text-gray-600 dark:text-slate-400">Kuala Lumpur</p>
                                </div>
                            </li>
                            <li class="flex">
                                <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                ...
                                <div class="ml-4 mb-4">
                                    ...
                                    <p class="text-gray-600 dark:text-slate-400">Mobile: +601116170827</p>
                                    <p class="text-gray-600 dark:text-slate-400">Mail: ahmad04akid@gmail.com</p>
                                </div>
                            </li>
                            <li class="flex">
                                <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
