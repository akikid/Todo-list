...
@section('content')
    ...
    <h3 class="text-3xl font-bold mb-4">Home Page</h3>
    <body>
        ...
        <!-- <h2 class="text-2xl font-bold mb-4">Tasks</h2> -->
            ...
            <div id="content" class="mx-auto" style="max-width:500px;">
                <div class="container content py-6 mx-auto">
                    <div class="mx-auto">
                        <div id="create-form" class="shadow-lg p-6 bg-white">
                            <div class="flex ">
                            ...
                            <div>
                                <form action="{{ route('home') }}" method="POST">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        @error('todo')
                                            <span class="text-red-500 text-xs mt-3 block ">Your todo cannot be empty</span>
                                        @enderror
                                    </div>
                                    <button type="submit"
                    ...
                    <div id="todos-list">
                        <div class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
                            <div class="flex justify-between space-x-2">
                                ...
                                <h3 class="text-lg text-semibold text-gray-800">{{ $todo->todo }}</h3>

                                <div class="flex items-center space-x-2">
                                    <form action="{{ route('home.edit', $todo) }}" method="GET">
                                        @csrf
                                        <button type="submit" class="text-sm text-teal-500 font-semibold rounded hover:text-teal-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    ...
                                    <form action="{{ route('home.delete', $todo) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-sm text-red-500 font-semibold rounded hover:text-teal-800 mr-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" class="w-4 h-4">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span class="text-xs text-gray-500"> {{ $todo->updated_at->format('d/m/Y h:i A') }} </span>
